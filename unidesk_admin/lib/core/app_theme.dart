...
class AppTheme {
  ...
  static const Color backgroundLight = Color(0xFFF3F4F6); // Off-white/gray
  ...
  static ThemeData get lightTheme {
    return ThemeData(
      ...
      navigationRailTheme: const NavigationRailThemeData(
        backgroundColor: backgroundLight,
        selectedIconTheme: IconThemeData(color: pastelBlueDark),
  ...
  static ThemeData get darkTheme {
    return ThemeData(
      ...
      colorSchemeSeed: pastelBlueDark,
      fontFamily: GoogleFonts.inter().fontFamily,
      textTheme:
      ...
      navigationRailTheme: const NavigationRailThemeData(
        backgroundColor: backgroundDark,
        selectedIconTheme: IconThemeData(color: pastelBlue),
        indicatorColor: pastelBlueDark,
        unselectedIconTheme: IconThemeData(color: Colors.grey),
        selectedLabelTextStyle: TextStyle(
          color: pastelBlue,
          fontWeight: FontWeight.bold,
